...
namespace API.Data
{
    public class LikesRepository(DataContext context, IMapper mapper) : ILikesRepository
    {
        ...
        public async Task<PaggedList<MemberDto>> GetUserLikes(LikesParams likesParams)
        {
            ...
            return await PaggedList<MemberDto>.CreateAsync(query, likesParams.PageNumber, likesParams.PageSize);
        }
